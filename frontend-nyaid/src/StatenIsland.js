...
useEffect(()=>{
    console.log('broooo')
    axios.get(`${API_URL}boroughs/mutualaids/?borough_id=5`).then((response) => {
...
console.log("in delete")
    ...
    axios.delete(`${API_URL}boroughs/mutualaids/?borough_id=5&id=${oneaid.id}`).then((response) => {
...
const onMutualAidClick = (mutualaid) => {
    ...
    axios.get(`${API_URL}boroughs/mutualaids/?borough_id=5&${mutualaid.id}`).then((response) => {
