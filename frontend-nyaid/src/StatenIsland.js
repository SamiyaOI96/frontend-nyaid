...
function StatenIsland() {
    ...
    useEffect(() => {
        console.log('hello')
        axios.get(`${API_URL}/mutualaids/boroughs/?borough_id=5`,).then((response) => {
    ...
    const onMutualAidSubmit = (newMA) => {
        console.log(newMA)
        axios.post(`${API_URL}/mutualaids/boroughs/?borough_id=5`, newMA).then((response) => {
            console.log('Response:', response.data);
    ...
    useEffect (() => {
        ...
        axios.get(`${API_URL}/boroughs/mutualaids?${selectedMutualAid.id}/?borough_id=5`).then((response) => {
    ...
    console.log("in delete")
        axios.delete(`${API_URL}/mutualaids/boroughs/?borough_id=5${selectedMutualAid.id}`).then((response) => {
    ...
    const onMutualAidClick = (mutualaid) => {
        ...
        axios.get(`${API_URL}/mutualaids/boroughs/?borough_id=5/${mutualaid.id}`).then((response) => {
    ...
    return (
        <div>
        <div className='Si__Css'>
            <h4>Staten Island Mutual Aid</h4>
                <div className="new__SIMutualAid section ">
