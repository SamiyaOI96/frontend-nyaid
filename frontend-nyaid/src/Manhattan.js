...
useEffect (() => {
    ...
    axios.get(`${API_URL}/boroughs/mutualaids?${selectedMutualAid.id}/?borough_id=3`).then((response) => {
...
console.log("in delete")
    axios.delete(`${API_URL}/mutualaids/boroughs/?borough_id=3${selectedMutualAid.id}`).then((response) => {
...
const onMutualAidClick = (mutualaid) => {
    ...
    return (
        <div>
            ...
            <div className='manhattan__Css'>
            <h4>Manhattan Mutual Aid</h4>
                <div className="new__MTMutualAid section ">
