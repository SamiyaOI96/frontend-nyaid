...
useEffect(() => {
    console.log('hello')
    axios.get(`${API_URL}/mutualaids/boroughs/?borough_id=1`,).then((response) => {
...
const onMutualAidSubmit = (newMA) => {
    console.log(newMA)
    axios.post(`${API_URL}/mutualaids/boroughs/?borough_id=1`, newMA).then((response) => {
        console.log('Response:', response.data);
...
useEffect (() => {
    ...
    axios.get(`${API_URL}/boroughs/mutualaids?${selectedMutualAid.id}/?borough_id=1`).then((response) => {
...
console.log("in delete")
    axios.delete(`${API_URL}/mutualaids/boroughs/?borough_id=1${selectedMutualAid.id}`).then((response) => {
...
const onMutualAidClick = (mutualaid) => {
    ...
    axios.get(`${API_URL}/mutualaids/boroughs/?borough_id=1/${mutualaid.id}`).then((response) => {
    ...
    return (
        <div>
            <div className='brooklyn__Css'>
            <h4>Brooklyn Mutual Aid</h4>
                <div className="new__BkMutualAid section ">
